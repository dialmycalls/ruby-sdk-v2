...
module DialMyCalls
  ...
  class CreateRecordingByPhoneParameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'whitelabel')
        self.whitelabel = attributes[:'whitelabel']
      end
    ...
    def hash
      [name, callerid_id, whitelabel, phone, extension].hash
    end
