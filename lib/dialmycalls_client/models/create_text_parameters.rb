...
module DialMyCalls
  ...
  class CreateTextParameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'keyword_id')
      ...
      if attributes.has_key?(:'shortcode_id')
        self.shortcode_id = attributes[:'shortcode_id']
      end

      if attributes.has_key?(:'concatenate_sms')
        self.concatenate_sms = attributes[:'concatenate_sms']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shortcode_id == o.shortcode_id &&
          concatenate_sms == o.concatenate_sms &&
          contacts == o.contacts
    end
    ...
    def hash
      [name, keyword_id, messages, send_at, send_immediately, send_email, accessaccount_id, shortcode_id, concatenate_sms, contacts].hash
    end
