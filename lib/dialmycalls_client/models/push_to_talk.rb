...
module DialMyCalls
  ...
  class PushToTalk
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ringtone')
        self.ringtone = attributes[:'ringtone']
      end

      if attributes.has_key?(:'cpm')
        self.cpm = attributes[:'cpm']
      end

      if attributes.has_key?(:'add_message')
    ...
    def hash
      [type, callerid_id, ringtone, cpm, add_message].hash
    end
