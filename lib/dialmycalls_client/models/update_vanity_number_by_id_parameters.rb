...
module DialMyCalls
  ...
  class UpdateVanityNumberByIdParameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'call_options')
        if (value = attributes[:'call_options']).is_a?(Array)
          self.call_options = value
        end
      end

      if attributes.has_key?(:'recording_source')
        self.recording_source = attributes[:'recording_source']
      end

      if attributes.has_key?(:'specific_recording_id')
        self.specific_recording_id = attributes[:'specific_recording_id']
      end

      if attributes.has_key?(:'play_cta')
        self.play_cta = attributes[:'play_cta']
      end

      if attributes.has_key?(:'ptt_number_id')
        self.ptt_number_id = attributes[:'ptt_number_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          call_options == o.call_options &&
          recording_source == o.recording_source &&
          specific_recording_id == o.specific_recording_id &&
          play_cta == o.play_cta &&
          ptt_number_id == o.ptt_number_id
    end
    ...
    def hash
      [call_options, recording_source, specific_recording_id, play_cta, ptt_number_id].hash
    end
